...
test_that ('works for phylo, standard, empirical', {
    ...
    sm <- sfreemap.map(sfreemap.trees[[1]], sfreemap.tips, type="standard", method="empirical")
...
test_that ('works for phylo, standard, empirical, Q given', {
    ...
    sm1 <- sfreemap.map(sfreemap.trees[[1]], sfreemap.tips, type="standard", method="empirical")
    sm2 <- sfreemap.map(sfreemap.trees[[1]], sfreemap.tips, Q=sm$Q, type="standard", method="empirical")
...
test_that ('works for phylo, dna, single taxa', {
    ...
    sm <- sfreemap.map(sfreemap.trees[[1]], sfreemap.tips.dna[,1], type="dna")
...
test_that ('works for phylo, dna, multiple taxa', {
    ...
    sm <- sfreemap.map(sfreemap.trees[[1]], sfreemap.tips.dna[,1:10], type="dna")
...
test_that ('works for phylo, dna, multiple taxa, Q given', {
    ...
    sm1 <- sfreemap.map(sfreemap.trees[[1]], sfreemap.tips.dna[,1:10], type="dna")
    Q <- lapply(sm1, function(x) x$Q)
    sm2 <- sfreemap.map(sfreemap.trees[[1]], sfreemap.tips.dna[,1:10], Q=Q, type="dna")
