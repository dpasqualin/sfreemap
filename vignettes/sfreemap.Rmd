...
data <- sfreemap.map(sfreemap.corals.trees, sfreemap.corals.tips, method='empirical', parallel=FALSE)
mpd <- sfreemap.map_posterior_distribution(data[[1]], data, parallel=FALSE)
```
...
data1 <- sfreemap.map(sfreemap.corals.trees[[1]], sfreemap.corals.tips, method='empirical', parallel=FALSE)
data2 <- sfreemap.map(sfreemap.corals.trees[[1]], sfreemap.corals.tips, method='mcmc', n_simulation=1, parallel=FALSE)
