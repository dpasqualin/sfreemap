...
Also, this command can run in parallel, with a number of process equal to the number of cores
in your machine. If you want to run in parallel just omit the parameter *parallel=FALSE*.
